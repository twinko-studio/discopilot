...
def test_channel_mapper():
    ...
    assert mapper.get_all_raw_cid() == ['RAW_AI_CID', 'RAW_DT_CID', 'RAW_WEB3_CID', 'RAW_ROBOTICS_CID', 'RAW_AIDD_CID', 'RAW_RESPONSIBLE_AI_CID']
    assert mapper.get_all_target_cid() == ['AI_CID', 'DT_CID', 'WEB3_CID', 'ROBOT_CID', 'AIDD_CID', 'RESPONSIBLE_AI_CID']
